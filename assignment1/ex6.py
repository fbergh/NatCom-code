...
def main():
    ...
    plot_route(coordinates, fittest_meme, title="Best tour of final memetic population",
               is_save=True, filename="img/"+dataset+"_tour_meme.png")
    plot_route(coordinates, fittest_norm, title="Best tour of final simple population",
               is_save=True, filename="img/"+dataset+"_tour_norm.png")
    plot_route(coordinates, opt_route, title="Optimal tour for "+dataset, is_save=True, filename="img/"+dataset+"_opt_tour.png")

    plot_statistics([avg_fit_meme, avg_fit_norm],
                    "Average fitness of memetic and simple algorithm", is_save=True, filename="img/"+dataset+"_avg_fit_vals.png")
    plot_statistics([best_fit_meme, best_fit_norm],
                    "Best fitness of memetic and simple algorithm", is_save=True, filename="img/"+dataset+"_best_fit_vals.png")

    print("Execution time in seconds for memetic algorithm: {}s".format(time_meme))
    print("Execution time in seconds for simple algorithm: {}s".format(time_norm))
